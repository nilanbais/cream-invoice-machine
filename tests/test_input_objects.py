...
from cream_invoice_machine.utils.input_objects import CorpInfoInput
...
class TestPDFGenerator(unittest.TestCase):
    ...
    def test_corp_input_set_data(self) -> None:
        ...
        self.assertTrue(test_obj._invoice_details, None)
        print(test_obj.CorpInvoiceDetails)
